...
const catalogFields: CatalogField[] = ["id", "revisionId", "title", "sourcePath", "metadata", "status", "updatedAt"];

function decodeCatalogCursor(cursor: string): { createdAt: number; id: string } {
